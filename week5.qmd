...
![Loading and displaying Landsat 9 satellite imagery using specific geographic locations (New Delhi), time frames (January and February 2020) and cloud coverage conditions (less than 10%)](images/新建%20PPTX%20演示文稿_页面_1.jpg){width="619"}
...
![Cropping the region defined by Delhi, the three bands \['SR_B4', 'SR_B3', 'SR_B2'\] were selected for visualisation, corresponding to the red, green and blue bands, which produces images close to true colour.](images/新建%20PPTX%20演示文稿_页面_2.jpg){width="559"}
